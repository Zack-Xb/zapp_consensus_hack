...
const styles = StyleSheet.create({
    container: {flex:1, display: 'flex', flexDirection: 'column', backgroundColor: '#232323',},
    header: {display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'},
    rightHeader: {display: 'flex', flexDirection: 'row', alignItems: 'center', width: '20%'},
    balanceDiv: {display:'flex', alignItems: 'flex-end',backgroundColor: '#111111'},
